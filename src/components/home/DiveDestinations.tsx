              ...
              {activeImages.length > 1 ? (
                <>
                  <button
                    ...
                    className="absolute left-5 top-1/2 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white/15 text-white backdrop-blur transition hover:bg-white/25"
                    aria-label="이전 이미지"
                  >
                  ...
                  <button
                    ...
                    className="absolute right-5 top-1/2 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white/15 text-white backdrop-blur transition hover:bg-white/25"
                    aria-label="다음 이미지"
                  >
                    <ChevronRight className="h-6 w-6" />
                  </button>

                  <div className="absolute bottom-5 left-1/2 flex -translate-x-1/2 gap-2 rounded-full bg-slate-950/40 px-3 py-2 backdrop-blur">
          ...
          <div className="mt-5 flex justify-center gap-3 overflow-x-auto pb-2">
            {activeImages.map((imageUrl, index) => (
              <button
                ...
                onClick={() => setImageIndex(index)}
                className={[
                  "relative h-20 w-28 shrink-0 overflow-hidden rounded-2xl bg-slate-200 ring-2 transition",
                  index === imageIndex
                    ? "ring-cyan-400"
